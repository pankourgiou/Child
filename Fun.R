 kernel("modified.daniell", c(20,20))          # for a list
plot(kernel("modified.daniell", c(40,40)))    # for a graph

par(mfrow=c(2,1))
k = kernel("modified.daniell", c(8,8))
...
soi.smo$bandwidth/12      # Bw = 17 units = month (value returned by mvspec)  
